...
export class CustomerDetailModalContentComponent implements OnInit {
		...
		if (
			...
			this._customerService
				...
				.catch((blApiError: BlApiError) => {
					console.log(
						"customerDetailModalContentComponent: could not update userDetail"
					);
					this.wait = false;
				});
		} else {
	...
	private getPatchedValues(): any {
		...
		userDetailPatch["emailConfirmed"] = this.userDetail.emailConfirmed
			? this.userDetail.emailConfirmed
			: false;
