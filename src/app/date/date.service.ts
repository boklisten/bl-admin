...
export class DateService {
	...
	public getCurrentSemesterPeriod(): { fromDate: Date, toDate: Date } {
		if (moment().isAfter(this._defaultSpringSemesterDeadlineDate) && moment().isSameOrBefore(this._defaultFallSemesterDeadlineDate)) {
	...
	public getAllTimePeriod(): {fromDate: Date, toDate: Date} {
		return {
			fromDate: moment().year(2000).date(1).month(1).hour(0).minute(0).second(0).millisecond(0).toDate(),
